...
(function ($$) {
    ...
    $$.math.inBezierVicinity = function (x, y, x1, y1, x2, y2, x3, y3, toleranceSquared) {
        ...
        var outside = function (x, y, startX, startY, endX, endY, toleranceSquared, counterClockwise) {
...
(function ($$) {
    ...
    $$.fn.core({
        ...
        startAnimationLoop: function () {
            ...
            var requestAnimationFrame = typeof window === 'undefined' ? function () {
...
(function ($$) {
    ...
    CanvasRenderer.prototype.notify = function (params) {
        ...
        this.data.canvasRedrawReason[DRAG].push("notify");
        this.data.canvasNeedsRedraw[NODE] = true;
        this.data.canvasRedrawReason[NODE].push("notify");
    ...
    // @O Initialization functions
    {
        CanvasRenderer.prototype.load = function () {
            ...
            r.registerBinding(window, "mousemove", function (e) {
                ...
                if (r.hoverData.which === 3) {
                    ...
                    if (near != last) {
                        ...
                        if (last) {
                            last.trigger(new $$.Event(e, {type: "mouseout"}));
                        }
                        if (near) {
                            near.trigger(new $$.Event(e, {type: "mouseover"}));
                        }
            ...
            r.registerBinding(window, "mouseup", function (e) {
                ...
                if (r.hoverData.which === 3) {
                    ...
                    if ((down == null) // not mousedown on node
                        ...
                        if (draggedElements.length > 0) {
                            r.data.canvasNeedsRedraw[NODE] = true;
                            r.data.canvasRedrawReason[NODE].push("De-select");
                        }
                    ...
                    if (near == down && !r.dragData.didDrag) {
                        if (near != null && near._private.selectable) {
                            ...
                            r.data.canvasNeedsRedraw[NODE] = true;
                            r.data.canvasRedrawReason[NODE].push("sglslct");
                    ...
                    if (cy.boxSelectionEnabled() && Math.pow(select[2] - select[0], 2) + Math.pow(select[3] - select[1], 2) > 7 && select[4]) {
                        ...
                        if (box.length > 0) {
                            r.data.canvasNeedsRedraw[NODE] = true;
                            r.data.canvasRedrawReason[NODE].push("Selection");
                        }
                    }
                    ...
                    if (!select[4]) {
                        ...
                        //				draggedElements = r.dragData.possibleDragElements = [];
                        r.data.canvasNeedsRedraw[DRAG] = true;
                        r.data.canvasRedrawReason[DRAG].push("Node/nodes back from drag");
                        r.data.canvasNeedsRedraw[NODE] = true;
                        r.data.canvasRedrawReason[NODE].push("Node/nodes back from drag");
                    }
                ...
                r.data.canvasNeedsRedraw[SELECT_BOX] = true;
                r.data.canvasRedrawReason[SELECT_BOX].push("Mouse up, selection box gone");
...
//			console.log("ss", select);
            ...
            r.registerBinding(r.data.container, "mousemove", function (e) {
                if (r.zoomData.lastPointerX && r.zoomData.lastPointerX != e.pageX && !r.zoomData.freeToZoom) {
                    r.zoomData.freeToZoom = true;
                }
                r.zoomData.lastPointerX = e.pageX;
            }, false);

            r.registerBinding(r.data.container, "mouseout", function (e) {
                r.zoomData.freeToZoom = false;
                r.zoomData.lastPointerX = null
            }, false);
            // --
            ...
            r.registerBinding(r.data.container, "touchstart", function (e) {
                ...
                if (e.touches[1]) {
                    var pos = r.projectIntoViewport(e.touches[1].pageX, e.touches[1].pageY);
                    now[2] = pos[0];
                    now[3] = pos[1];
                }
                if (e.touches[2]) {
                    var pos = r.projectIntoViewport(e.touches[2].pageX, e.touches[2].pageY);
                    now[4] = pos[0];
                    now[5] = pos[1];
                }
...
// console.log = function(m){ $('#console').append('<div>'+m+'</div>'); };
            ...
            r.registerBinding(window, "touchmove", function (e) {
                ...
                if (capture && r.touchData.cxt) {
                    ...
                    {
                        if (start != null) {
                            start.trigger(new $$.Event(e, {type: "touchmove"}));
                        }

                        if (start == null) {
                            var near = r.findNearestElement(now[0], now[1], true);
                            if (near != null) {
                                near.trigger(new $$.Event(e, {type: "touchmove"}));
                            }
                            if (near == null) {
                                cy.trigger(new $$.Event(e, {type: "touchmove"}));
                            }
                        }

                        if (near != last) {
                            if (last) {
                                last.trigger(new $$.Event(e, {type: "touchout"}));
                            }
                            if (near) {
                                near.trigger(new $$.Event(e, {type: "touchover"}));
                            }
                        }
            ...
            r.registerBinding(window, "touchend", function (e) {
                ...
                if (e.touches[2]) {
                    ...
                    if (start != null) {
                        ...
                        r.data.canvasNeedsRedraw[DRAG] = true;
                        r.data.canvasRedrawReason[DRAG].push("touchdrag node end");
                        r.data.canvasNeedsRedraw[NODE] = true;
                        r.data.canvasRedrawReason[NODE].push("touchdrag node end");
        ...
        CanvasRenderer.prototype.redraw = function (forcedContext, drawAll, forcedZoom, forcedPan) {
            ...
            setTimeout(function () {
                ...
                if (data.canvasNeedsRedraw[NODE] || drawAll) {
                    ...
                    if (!drawAll) {
                        data.canvasNeedsRedraw[NODE] = false;
                        data.canvasRedrawReason[NODE] = [];
                    }
                }
                ...
                if (data.canvasNeedsRedraw[DRAG] || drawAll) {
                    ...
                    if (!drawAll) {
                        data.canvasNeedsRedraw[DRAG] = false;
                        data.canvasRedrawReason[DRAG] = [];
                    }
                }
                ...
                if (data.canvasNeedsRedraw[SELECT_BOX]) {
                    ...
                    if (!drawAll) {
                        data.canvasNeedsRedraw[SELECT_BOX] = false;
                        data.canvasRedrawReason[SELECT_BOX] = [];
                    }
                }
...
//		context.setTransform(1, 0, 0, 1, 0, 0);
        ...
        CanvasRenderer.prototype.drawBackground = function (context, color1, color2, startPosition, endPosition) {
...
//			edge.target()[0]._private.style["height"].value);
        ...
        {
            CanvasRenderer.prototype.intersectLineEllipse = function (x, y, centerX, centerY, ellipseWradius, ellipseHradius) {
            ...
            CanvasRenderer.prototype.dotProduct = function (vec1, vec2) {
            ...
            CanvasRenderer.prototype.intersectLineCircle = function (x1, y1, x2, y2, centerX, centerY, radius) {
            ...
            CanvasRenderer.prototype.findCircleNearPoint = function (centerX, centerY, radius, farX, farY) {
            ...
            CanvasRenderer.prototype.finiteLinesIntersect = function (x1, y1, x2, y2, x3, y3, x4, y4, infiniteLines) {
            ...
            CanvasRenderer.prototype.boxIntersectEllipse = function (x1, y1, x2, y2, padding, width, height, centerX, centerY) {
            ...
            CanvasRenderer.prototype.boxIntersectPolygon = function (x1, y1, x2, y2, basePoints, width, height, centerX, centerY, direction, padding) {
...
//		console.log(arguments);
            ...
            CanvasRenderer.prototype.polygonIntersectLine = function (x, y, basePoints, centerX, centerY, width, height, padding) {
            ...
            CanvasRenderer.prototype.shortenIntersection = function (intersection, offset, amount) {
...
//			console.log(arguments);
                    ...
                    checkPointRough: function (x, y, padding, width, height, centerX, centerY) {
...
//		console.log(star5Points);
        ...
        // @O Polygon calculations
        {
            ...
            CanvasRenderer.prototype.pointInsidePolygon = function (x, y, basePoints, centerX, centerY, width, height, direction, padding) {
...
//*		console.log("up: " + up + ", down: " + down);
        ...
        CanvasRenderer.prototype.roundRectangleIntersectLine = function (x, y, nodeX, nodeY, width, height, padding) {
        ...
        CanvasRenderer.prototype.roundRectangleIntersectBox = function (boxX1, boxY1, boxX2, boxY2, width, height, centerX, centerY, padding) {
        ...
        CanvasRenderer.prototype.checkInBoundingCircle = function (x, y, farthestPointSqDistance, padding, width, height, centerX, centerY) {
        ...
        CanvasRenderer.prototype.checkInBoundingBox = function (x, y, points, padding, width, height, centerX, centerY) {
        ...
        {
            CanvasRenderer.prototype.boxInBezierVicinity = function (x1box, y1box, x2box, y2box, x1, y1, x2, y2, x3, y3, tolerance) {
            ...
            CanvasRenderer.prototype.checkBezierInBox = function (x1box, y1box, x2box, y2box, x1, y1, x2, y2, x3, y3, tolerance) {
            ...
            CanvasRenderer.prototype.checkStraightEdgeInBox = function (x1box, y1box, x2box, y2box, x1, y1, x2, y2, tolerance) {
            ...
            CanvasRenderer.prototype.checkStraightEdgeCrossesBox = function (x1box, y1box, x2box, y2box, x1, y1, x2, y2, tolerance) {
            ...
            CanvasRenderer.prototype.checkBezierCrossesBox = function (x1box, y1box, x2box, y2box, x1, y1, x2, y2, x3, y3, tolerance) {
            ...
            CanvasRenderer.prototype.inBezierVicinity = function (x, y, x1, y1, x2, y2, x3, y3, toleranceSquared) {
            ...
            CanvasRenderer.prototype.sqDistanceToQuadraticBezier = function (x, y, x1, y1, x2, y2, x3, y3) {
